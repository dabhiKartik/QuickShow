...
// // export const dummyDateTimeData1 = {
// //     "2025-07-24": [
...
// // const formattedDate=showDate.toLocaleString("default",{weekday:"short",day: 'numeric' })
...
// // const map = groupRows[0].map((row) => render(row));
...
// export const BookingdateFormate=(date)=>{
...
// console.log(BookingdateFormate("2025-07-24T01:00:00.000Z"));
...
// const movie_title=dummyShowsData.map((show)=>{
// console.log(show.title);
// console.log(BookingdateFormate(show.));
...
// function cloning_Array (array){
//     const Array=[...array]
//     return Array
// }

// console.log(cloning_Array([1,2,[3,4]]));
