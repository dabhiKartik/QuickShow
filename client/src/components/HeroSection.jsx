...
const HeroSection = () => {
  ...
  return (
    <div
     ...
     h-screen bg-[url('/backgroundImage.png')] bg-cover bg-center  "
    >
      <img
      ...
      <button
        ...
        className=' flex items-center gap-1 px-6 py-3 text-sm w-fit bg-primary hover:bg-primary-dull transition rounded-full font-medium cursor-pointer'
      >
        Explore Movies
